...
filehandle = open("textfile.txt","w");
...
for i in range(p_length):
    filehandle.write("Progress - {} , {} , {} ".format(Progress_list[a],Progress_list[a+1],Progress_list[a+2])+"\n")
    a = a + 3
...
for i in range(mt_length):
    filehandle.write("Progress (module trailer) - {} , {} , {}".format(Module_trailer_list[b],Module_trailer_list[b+1],Module_trailer_list[b+2])+"\n")
    b = b + 3
...
for i in range(mr_length):
    filehandle.write("Module retriever - {} , {} , {}".format(Module_retriever_list[c],(Module_retriever_list[c+1]),Module_retriever_list[c+2])+"\n")
    c = c + 3
...
for i in range(e_length):
    filehandle.write("Exclude - {} , {} , {}".format(Exclude_list[d],Exclude_list[d+1],Exclude_list[d+2]))
    d = d + 3
...
filehandle = open("textfile.txt","r")
